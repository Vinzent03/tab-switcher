...
To keep iterating through tabs with repeated key presses, you need to keep a modifier key held between presses. This works with whichever hotkeys you assign in Obsidian, not only <kbd>Ctrl</kbd> + <kbd>Tab</kbd>.
